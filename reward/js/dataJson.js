 ...
 * 
 * 点击的链接加上<a>标签，如："Official website：<a href='https://gamechain.world' target='_blank'>https://gamechain.world</a>"
 * 
 */
 ...
 *  https://goo.gl/forms/rDscU8xoGcoREX1I3         
    ...
    https://gamechainworld.mikecrm.com/B4LOyEe         视频转发后填写此表单---暂时舍弃
    视频发布和转发的表单
    ...
    https://gamechainworld.mikecrm.com/DnPX5ZQ           申请资格表单
    翻译资格审核

    https://gamechainworld.mikecrm.com/xmhX54k           领取白皮书翻译表单
    领取白皮书翻译

    https://gamechainworld.mikecrm.com/cWaIpZg           白皮书提交表单  （是不是？？？）      
    翻译白皮书

    https://gamechainworld.mikecrm.com/165ryhe           完成文案后提交翻译表单：   
    翻译文件提交

    https://gamechainworld.mikecrm.com/qdXDekN           完成审核提交表单：                      
    审核表单
 */
    ...
    cn: [
            {
                ...
                content: {
                    ...
                    rule: ["Official website：<a href='https://gamechain.world' target='_blank'>https://gamechain.world</a>",
            ...
            /*{
                ...
                content: {
                    ...
                    join: ["首先需要申请资格，申请资格表单：<a href='https://gamechainworld.mikecrm.com/DnPX5ZQ' target='_blank'>申请资格表单</a>",
                        //    "填写并提交此表单（获得资格的用户在开始翻译/审核前做此操作）：<a href='' target='_blank'>登记表格（Google表格）</a>",
                        "领取白皮书翻译表单：<a href='https://gamechainworld.mikecrm.com/xmhX54k' target='_blank'>翻译表单</a>",
                        "白皮书提交表单：<a href='https://gamechainworld.mikecrm.com/cWaIpZg' target='_blank'>翻译表单</a>",
                        "完成文案后提交翻译表单：<a href='https://gamechainworld.mikecrm.com/165ryhe ' target='_blank'>文案翻译表单</a>",
                        "完成审核提交表单：<a href='https://gamechainworld.mikecrm.com/qdXDekN' target='_blank'>审核表单</a>"],
                    
                    rule: ["需要获得翻译/审核资格。提交申请的用户是否能获得翻译/审核资格由官方决定。",
                        "获得白皮书翻译任务资格的用户在提交<a href='https://gamechainworld.mikecrm.com/DnPX5ZQ' target='_blank'>登记表格（Google表格）</a> 后，有10天的时间来完成翻译任务。",
                        "获得文案翻译任务资格的用户在提交<a href='https://gamechainworld.mikecrm.com/DnPX5ZQ' target='_blank'>登记表格（Google表格）</a> 后，有2天的时间来完成翻译任务。",
                        "获得审核任务资格的用户在提交<a href='https://gamechainworld.mikecrm.com/DnPX5ZQ' target='_blank'>登记表格（Google表格）</a> 后，有1天的时间来完成审核任务。",
    ...
    en: [
            ...
            /*{
                ...
                content: {
                    ...
                    join: ["First, you need apply for the qualification: <a href='https://gamechainworld.mikecrm.com/DnPX5ZQ' target='_blank'>Applicant Qualification Form.</a>",
                        ...
                        "Receive white paper translation form: <a href='https://gamechainworld.mikecrm.com/xmhX54k' target='_blank'>Translation Form</a>",
                        "Submit white paper translation: <a href='https://gamechainworld.mikecrm.com/cWaIpZg' target='_blank'>Translation Form</a>",
                        " Submit copywriting translation form: <a href='https://gamechainworld.mikecrm.com/165ryhe ' target='_blank'>Copywriting Translation Form</a>",
                        "Finish and submit review & verification form : <a href='https://gamechainworld.mikecrm.com/qdXDekN' target='_blank'>Review & Verification Form</a>"],
                    ...
                    rule: ["You need to get translation/review & verification qualification.Whether users  are qualified for translation/review & verification, is decided by the official authority.",
                        "Users who qualify for white paper translation, after submitting <a href='https://gamechainworld.mikecrm.com/DnPX5ZQ' target='_blank'>registration form (Google form)</a>, have 10 days to finish the translation task. ",
                        "Users who qualify for copywriting translation, after submitting <a href='https://gamechainworld.mikecrm.com/DnPX5ZQ' target='_blank'>registration form (Google form)</a>, have 2 days to finish the translation task. ",
                        "Users who qualify for review & verification, after submitting <a href='https://gamechainworld.mikecrm.com/DnPX5ZQ' target='_blank'>registration form (Google form)</a> have 1 day to finish the review & verification task. ",
