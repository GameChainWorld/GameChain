$(function(){
   ...
   var clickEvent = function(){
         $(".lay_button").unbind("click").click(function(){
            ...
            // var loginurl = "https://gamechain.world:8443/whitelist/general/login";
            var loginurl = "https://gamechain.world:8443/whitelist/general/login";
        ...
        $(".lay_send").unbind("click").click(function(){
            ...
            if(!checkPwd()) return;
            var form = new FormData(document.getElementById("form_common_id"));
            // var regurl = "https://gamechain.world:8443/whitelist/general/nocoderegister";
            var regurl = "https://gamechain.world:8443/whitelist/general/registercodeornocode";
        ...
        $(".lay_submit").unbind("click").click(function(){
            ...
            var form = new FormData(document.getElementById("form_common_id"));
            // var regurl = "https://gamechain.world:8443/whitelist/general/forgetPsw";
            var regurl = "https://gamechain.world:8443/whitelist/general/forgetPsw";
            submitForm(regurl,form);
        });
   }
    ...
    var user_function = function(){
        ...
        if(userInfo){
            ...
            $("#user-login .user-info").children("div").eq(0).bind("click", function(event){
                ...
                //发送ajax请求获取用户个人数据
                var url = "https://gamechain.world:8443/whitelist/general/personinfo?account="+ userInfo.account +"&uid="+ userInfo.id;
                var data = "";
    ...
    function get_invitationCode(userInfo){
        //发送ajax请求获取用户个人数据
        var url = "https://gamechain.world:8443/whitelist/general/invitenew?wkey=whitelist&uid="+ userInfo.id;
        var data = "";
        ...
        function getInvitation_callback(result){
            if(result.status == 0){
                ...
                addScript("https://gamechain.world/js/invitation_card.js");//生成邀请函图片
            }else{
                console.log("生成邀请码失败！")
                $(".container-outer form .form-content").empty();
                $(".container-outer form .form-content").append(
